...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4" style="color: #103458;">Statistik Arsip Unit Pengolah</h5>

        <div class="row g-3 mb-3">
            @foreach($statistikUnit as $unit)
                <div class="col-xl-3 col-md-6">
                    <div class="border rounded text-center p-3 h-100 hover-scale" style="background-color: #f8f9fa;">
                        <div class="small text-secondary fw-bold mb-2 text-uppercase">{{ $unit->nama_unit }}</div>
                        <div class="h2 fw-bold mb-0" style="color: #103458;">{{ $unit->arsip_count }}</div>
                    </div>
                </div>
            @endforeach
        </div>
...
<div class="card shadow-sm border-0 mb-4">  
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4" style="color: #103458;">Statistik Arsip Total</h5>

        <div class="row g-3">
            
            <div class="col-xl-4 col-md-6">
                <div class="border rounded text-center p-3 h-100 hover-scale" style="background-color: #f8f9fa;">
                    <div class="small text-secondary fw-bold mb-2">Total Arsip Publik</div>
...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4" style="color: #103458;"><i class="fas fa-clock me-2"></i> 5 Arsip Terbaru Menunggu Verifikasi</h5>
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-3">Tidak ada antrean arsip saat ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
