...
<div class="card shadow-sm mb-4 border-0">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4" style="color: #103458;">Statistik Arsip</h5>
        <div class="row g-4">
            ...
            <div class="col-xl-6 col-md-6">
                <div class="border rounded text-center p-3 h-100 hover-scale" style="background-color: #f8f9fa;">
                    ...
                    <div class="h2 fw-bold mb-0" style="color: #103458;">{{ $totalSemuaArsip }}</div>
                </div>
            </div>

            <div class="col-xl-6 col-md-6">
                <div class="border rounded text-center p-3 h-100 hover-scale" style="background-color: #f8f9fa;">
                    <div class="small text-secondary fw-bold mb-2">Total Arsip PPID</div>
...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-4" style="color: #103458;"><i class="fas fa-clock me-2"></i> 5 Arsip Terbaru</h5>
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-3">Belum ada aktivitas arsip terbaru.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
